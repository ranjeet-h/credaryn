...
reported to the maintainer via the contact method on their GitHub profile
(<https://github.com/ranjeet-h>). For security-sensitive reports, use the
private channel in [`SECURITY.md`](SECURITY.md). All complaints will be reviewed
