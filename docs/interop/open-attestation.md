...
OpenAttestation issuance is not part of Credaryn. No customer fixture or adoption test currently requires a legacy OpenAttestation verification path, and adding one would introduce a second issuance contract without evidence.
